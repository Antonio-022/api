...
namespace API_SAADS_CORE_61.Helpers
{
    public sealed class VerhoeffCheckDigit
    {
        ...
        public static long VerhoeffXDig(int pNumero, int pNDigito)
        {
            string rResultado = "";


            for (int i = 0; i < pNDigito; i++)
            {
                rResultado += CalculateCheckDigit(pNumero).ToString();
                pNumero = AppendCheckDigit(pNumero);


            }

            return long.Parse(rResultado);

        }

        public static long VerhoeffXDig(long pNumero, int pNDigito)
        {
            string rResultado = "";
        ...
        public static string VerhoeffXDigCAD(long pNumero, int pNDigito)
        {
            string rResultado = "";
        ...
        public static string VerhoeffXDigCon(int pNumero, int pNDigito)
        {
            string rResultado = pNumero.ToString();
            string cadPNumero = pNumero.ToString();


            for (int i = 0; i < pNDigito; i++)
            {
                rResultado += CalculateCheckDigit(cadPNumero).ToString();
                cadPNumero = AppendCheckDigit(cadPNumero);
        ...
        public static string VerhoeffXDigCon(long pNumero, int pNDigito)
        {
            string rResultado = pNumero.ToString();
            string cadPNumero = pNumero.ToString();
