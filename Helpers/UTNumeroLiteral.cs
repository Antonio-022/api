...
{
    public class UTNumeroLiteral
    {
        public static string NumeroOrdinal(int x)
        {
            List<string> g1 = new List<string>();
            g1.Add("PRIMER"); g1.Add("SEGUNDO"); g1.Add("TERCER");
            g1.Add("CUARTO"); g1.Add("QUINTO"); g1.Add("SEXTO");
            g1.Add("SEPTIMO"); g1.Add("OCTAVO"); g1.Add("NOVENO");

            List<string> g2 = new List<string>();
            g2.Add("DECIMO"); g2.Add("VIGESIMO"); g2.Add("TRIGESIMO");
            g2.Add("CUADRAGESIMO"); g2.Add("QUINCAGESIMO"); g2.Add("SEXAGESIMO");
            g2.Add("SEPTUAGESIMO"); g2.Add("OCTOGESIMO"); g2.Add("NONAGESIMO");

            String num = x.ToString();
            if (x > 9)
            {
                int c = int.Parse(num.ElementAt(0).ToString());
                string cad = g2.ElementAt(c - 1);
                c = int.Parse(num.ElementAt(1).ToString());
                if (c != 0)
                    cad = cad + " " + g1.ElementAt(c - 1);
                cad = cad.Trim();
                return cad;
            }
            else
                return g1.ElementAt(x - 1);
        ...
        public String Convertir(String numero, bool mayusculas = false, bool moneda = true)
        {
            ...
            if (mc.Count > 0)
            {
                ...
                if (moneda)
                    parte_decimal = Num[1].Substring(0, 2) + "/100 Bolivianos.";
                else
                    parte_decimal = "";

                //parte_decimal = Num[1].Substring(0, 2);
